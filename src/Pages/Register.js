                    ...
                    <Form onSubmit={handleSubmit}>
                        <Row>
                            <Form.Group className="mb-3 col-lg-6">
                                ...
                                <Form.Control name="firstName" type="text" placeholder="Primer Nombre" required />
                            </Form.Group>
                            <Form.Group className="mb-3 col-lg-6">
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control name="username" type="text" placeholder="Nombre de Usuario" minLength={3} required />
                        </Form.Group>
                        <Form.Group className="mb-3">
